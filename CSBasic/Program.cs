...
namespace CSBasic
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(14.0 / 3.0);// 4.666666
            // Console.WriteLine(14.0 % 3.0);
            Console.WriteLine(14 / 3); // 4
            Console.WriteLine(14.0 / 3); // 4.666666
            Console.WriteLine(14 / 3.0); // 4.666666
            Console.WriteLine(14.0 / 3.0); // 4.666666
            ...
            //sizeof(자료형)
            Console.Write("int : " + sizeof(int));
            Console.Write("long : " + sizeof(long));
            Console.Write("float : " + sizeof(float));
            Console.Write("double : " + sizeof(double));
            Console.Write("char : " + sizeof(char));
            ...
            {
                Console.WriteLine("숫자를 입 력하세요 : " + e.Message);
            }
            catch(Exception e)
            {
